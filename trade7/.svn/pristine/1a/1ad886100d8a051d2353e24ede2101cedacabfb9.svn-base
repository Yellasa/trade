 ...
 */
@JobFlow(value = "0006_002_003", version = "1.0", template = ATradeModSingleTxNoPaymentTemp.class)
public class SinglePaymentRefundOuterOfflineDebitProcess implements TradeModSingleTxNoPaymentInterface<TradePacketReqBodyOuterRefundSuccessUpdate> {

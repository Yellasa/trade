 ...
 * v1.0
 */
@JobFlow(value = "0002_001_999", version = "1.0", template = ATradePageQueryNoPaymentTemp.class)
public class QueryByPageSingleWithdrawInnerProcess
        implements TradePageQueryInterface<TradePacketReqBodySingleWithdrawPageDetails> {

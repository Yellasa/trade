...
public interface TradeCreateSingleTxNoPaymentInterface<B extends TradeRequestBody> {
     ...
     * 交易创建
     */
    void tradeCreate(TradeRequest<B> tradeRquest) throws Exception;

    /**
     * 更新交易为失败状态
     */
    void tradeUpdateForFail(TradeRequest<B> tradeRquest) throws Exception;

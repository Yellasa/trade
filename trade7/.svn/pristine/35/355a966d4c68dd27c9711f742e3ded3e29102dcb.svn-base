 ...
 * 交易列表查询 付款 请求VO
 */
public class TradePacketReqBodyPayPageDetails extends TradeRequestBody implements Paging {
    /**
     * 参数名：交易编号<br/>
     * 参数类型：可空<br/>
     */
     ...
     * 版本：1.1
     */
    @Pattern(message = "payment_account_no format error", regexp = "\\s||([\\w]{2,32})", groups = Format.class)
     ...
     * 冻结成功起始日期时间
     */
    @DateTime(message = "gmt_freeze_success_datetime_start format error", groups = Format.class)
    private String gmt_freeze_success_datetime_start;
    /**
     * 冻结成功结束日期时间
     */
    @DateTime(message = "gmt_freeze_success_datetime_end format error", groups = Format.class)
    private String gmt_freeze_success_datetime_end;
    /**
     * 解冻成功起始日期时间
     */
    @DateTime(message = "gmt_un_freeze_success_datetime_start format error", groups = Format.class)
    private String gmt_un_freeze_success_datetime_start;
    /**
     * 解冻成功结束日期时间
     */
    @DateTime(message = "gmt_un_freeze_success_datetime_end format error", groups = Format.class)
    private String gmt_un_freeze_success_datetime_end;
    /**
     * 解冻扣款成功起始日期时间
     */
    @DateTime(message = "gmt_un_freeze_settlement_success_datetime_start format error", groups = Format.class)
    private String gmt_un_freeze_settlement_success_datetime_start;
    /**
     * 解冻扣款成功结束日期时间
     */
    @DateTime(message = "gmt_un_freeze_settlement_success_datetime_end format error", groups = Format.class)
    private String gmt_un_freeze_settlement_success_datetime_end;
    /**
     * 交易客户保留字段1
     */
    @Pattern(message = "extend_field_1_accurate_query format error", regexp = ".{0,1024}", groups = Format.class)
    ...
    public String getGmt_freeze_success_datetime_start() {
        return gmt_freeze_success_datetime_start;
    }

    public void setGmt_freeze_success_datetime_start(String gmt_freeze_success_datetime_start) {
        this.gmt_freeze_success_datetime_start = gmt_freeze_success_datetime_start;
    }

    public String getGmt_freeze_success_datetime_end() {
        return gmt_freeze_success_datetime_end;
    }

    public void setGmt_freeze_success_datetime_end(String gmt_freeze_success_datetime_end) {
        this.gmt_freeze_success_datetime_end = gmt_freeze_success_datetime_end;
    }

    public String getGmt_un_freeze_success_datetime_start() {
        return gmt_un_freeze_success_datetime_start;
    }

    public void setGmt_un_freeze_success_datetime_start(String gmt_un_freeze_success_datetime_start) {
        this.gmt_un_freeze_success_datetime_start = gmt_un_freeze_success_datetime_start;
    }

    public String getGmt_un_freeze_success_datetime_end() {
        return gmt_un_freeze_success_datetime_end;
    }

    public void setGmt_un_freeze_success_datetime_end(String gmt_un_freeze_success_datetime_end) {
        this.gmt_un_freeze_success_datetime_end = gmt_un_freeze_success_datetime_end;
    }

    public String getGmt_un_freeze_settlement_success_datetime_start() {
        return gmt_un_freeze_settlement_success_datetime_start;
    }

    public void setGmt_un_freeze_settlement_success_datetime_start(String gmt_un_freeze_settlement_success_datetime_start) {
        this.gmt_un_freeze_settlement_success_datetime_start = gmt_un_freeze_settlement_success_datetime_start;
    }

    public String getGmt_un_freeze_settlement_success_datetime_end() {
        return gmt_un_freeze_settlement_success_datetime_end;
    }

    public void setGmt_un_freeze_settlement_success_datetime_end(String gmt_un_freeze_settlement_success_datetime_end) {
        this.gmt_un_freeze_settlement_success_datetime_end = gmt_un_freeze_settlement_success_datetime_end;
    }

...
public class TradeTransferAccountLog {
    private Long id;
    ...
    private Date gmtTransferSuccess;
    ...
    public Date getGmtTransferSuccess() {
        return gmtTransferSuccess;
    }

    public void setGmtTransferSuccess(Date gmtTransferSuccess) {
        this.gmtTransferSuccess = gmtTransferSuccess;
    }

...
@JobFlow(value = "0007_001_998", version = "1.0", template = ATradePageQueryNoPaymentTemp.class)
public class QueryByPage4TransferOuterProcess implements TradePageQueryInterface<QueryPage4TransferDetail> {

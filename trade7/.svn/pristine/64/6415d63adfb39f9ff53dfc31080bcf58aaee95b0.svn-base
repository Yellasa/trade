...
public class TradePacketReqCommonTest {
    ...
    public void TestReqObjToXml() {
        ...
        head.setBusi_code("1");
        head.setRequest_code("0001_0001_001");
    ...
    public void TestReqXmlToObj() {
        TradePacketReqCommon tradePacketReqCommon = null;
        tradePacketReqCommon = (TradePacketReqCommon) TradePacketReqCommon
                .unmarshal(
                        "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><Trade><head><auth_code>0001</auth_code><busi_code>1</busi_code><core_merchant_no>CC99999999</core_merchant_no><fund_pool_no>0001</fund_pool_no><partner_id>100000000999</partner_id><request_code>0001_0001_001</request_code><request_time>201512150403230040</request_time><sign>tradepacketmerchantfreeze</sign><system_code>0</system_code><version>1.0</version></head><body><freeze_amount>100.00</freeze_amount><merchant_extend_field_1>merchant_extend_field_1</merchant_extend_field_1><merchant_extend_field_2>merchant_extend_field_2</merchant_extend_field_2><merchant_extend_field_3>merchant_extend_field_3</merchant_extend_field_3><merchant_extend_field_4>merchant_extend_field_4</merchant_extend_field_4><merchant_extend_field_5>merchant_extend_field_5</merchant_extend_field_5><out_trade_no>10201512141446000001</out_trade_no><out_trade_no_ext>102015121414460000010001</out_trade_no_ext><payment_account_no>CA9999999999</payment_account_no></body></Trade>",
                        TradePacketReqCommon.class);

        Assert.assertNotNull(tradePacketReqCommon);
    }

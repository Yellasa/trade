...
@JobFlow(value = "0005_001_999", version = "1.0", template = ATradePageQueryNoPaymentTemp.class)
public class QueryByPageRechargeInnerProcess implements TradePageQueryInterface<QueryPage4RechargeDetail> {

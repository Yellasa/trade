...
//			creditAccountTradeHistory.setSysTime(new Date());// 修改为插入数据库时间
	...
	/* (non-Javadoc)
	 * @see com.liantuo.deposit.advanceaccount.bus.service.CreditAccountTradeHistoryService#singleAccountHisPageQueryStand(com.liantuo.deposit.advanceaccount.web.vo.req.SingleAccountHisQueryReqVo)
	 */
	@Override
	public List<SingleAccountAccountRecord> singleAccountHisPageQueryStand(
		...
		return creditAccountTradeHistoryMapper.singleAccountHisPageQueryStand(queryVo);
	}
	...
	public Integer countSingleAccountHisQuery(SingleAccountHisQueryReqVo req) {
		...
		return creditAccountTradeHistoryMapper.countSingleAccountHisQueryStand(queryVo);
	}
}

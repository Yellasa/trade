 ...
 * @author zzd
 * @version V1.0
 * @ClassName: TradePacketReqBodyInnerPayment 内部支付付款
 * @Description: 0006_001_001 V1.0
 * Company:联拓金融信息服务有限公司
 * @Date 2016-6-2
 */
public class TradePacketReqBodyInnerPayment extends TradeRequestBody {
     ...
     * 参数类型：必填</br>
     */
    @ConflictWeak(message="当支付方式为损益直付或者损益充付时，付款方损益收入减少金额与付款方损益成本费用增加金额有且只有一个存在", 
		       mutual_exclusion_prop_name="pay_profit_loss_income_decr,pay_profit_loss_cost_incr", exclusion_prop_value="[23]", groups = {WeakRequired.class})
    @NotBlank(message = "pay_type is required", groups = {Required.class})
    @Pattern(message = "pay_type format error", regexp = "[123]", groups = Format.class)
    private String pay_type;

    /**
     * 参数名：付款方损益业务台账客户保留字段1</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_extend_field_1 format error", regexp = ".{0,1024}", groups = Format.class)
    private String pay_profit_loss_extend_field_1;


    /**
     * 参数名：付款方损益业务台账客户保留字段2</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_extend_field_2 format error", regexp = ".{0,1024}", groups = Format.class)
    private String pay_profit_loss_extend_field_2;

    /**
     * 参数名：付款方损益业务台账客户保留字段3</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_extend_field_3 format error", regexp = ".{0,1024}", groups = Format.class)
    private String pay_profit_loss_extend_field_3;

    /**
     * 参数名：付款方损益损益属性1</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_1 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_1;

    /**
     * 参数名：付款方损益损益属性2</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_2 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_2;

    /**
     * 参数名：付款方损益损益属性3</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_3 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_3;

    /**
     * 参数名：付款方损益损益属性4</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_4 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_4;

    /**
     * 参数名：付款方损益损益属性5</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_5 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_5;

    /**
     * 参数名：付款方损益损益属性6</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_6 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_6;

    /**
     * 参数名：付款方损益损益属性7</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_7 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_7;

    /**
     * 参数名：付款方损益损益属性8</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_8 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_8;

    /**
     * 参数名：付款方损益损益属性9</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_9 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_9;

    /**
     * 参数名：付款方损益损益属性10</br>
     * 参数类型：可空</br>
     */
    @Pattern(message = "pay_profit_loss_attr_10 format error", regexp = ".{0,128}", groups = Format.class)
    private String pay_profit_loss_attr_10;

    /**
     * 参数名：付款方损益收入减少金额</br>
     * 参数类型：可空</br>
     */
    @DecimalMin(message = "pay_profit_loss_income_decr format error", groups = {Format.class}, value = "0.01")
    @Digits(message = "pay_profit_loss_income_decr format error", groups = {Format.class}, integer = TradeConstants.DIGIT_AMOUNT_LENGTH, fraction = 2)
    private String pay_profit_loss_income_decr;


    /**
     * 参数名：付款方损益成本费用增加金额</br>
     * 参数类型：可空</br>
     */
    @DecimalMin(message = "pay_profit_loss_cost_incr format error", groups = {Format.class}, value = "0.01")
    @Digits(message = "pay_profit_loss_cost_incr format error", groups = {Format.class}, integer = TradeConstants.DIGIT_AMOUNT_LENGTH, fraction = 2)
    private String pay_profit_loss_cost_incr;

    /**
     * 参数名：付款方账户账户编号</br>
     * 参数类型：可空</br>
     */
    @AssociateWeak(message="【付款方付出方式】为账户、损益充付时,pay_account_no必填", 
    		associate_prop_name = "pay_type", associate_prop_value = "[13]", groups = {WeakRequired.class})
     ...
     * 参数类型：可空</br>
     */
    @AssociateWeak(message="【付款方付出方式】为账户、损益充付时,pay_account_out_accounting_amt必填", 
    		associate_prop_name = "pay_type", associate_prop_value = "[13]", groups = {WeakRequired.class})
     ...
     * 参数类型：可空</br>
     */
    @AssociateWeak(message="付款方手续费账户出账金额不为空时，付款方手续费账户账户编号不可为空", 
    		associate_prop_name = "pay_fee_account_out_accounting_amt", associate_prop_value = "\\d{1,13}(?:\\.\\d{1,2})?", groups = {WeakRequired.class})
    ...
    public String getPay_profit_loss_extend_field_1() {
        return pay_profit_loss_extend_field_1;
    }

    public void setPay_profit_loss_extend_field_1(String payProfitLossExtendField_1) {
        pay_profit_loss_extend_field_1 = payProfitLossExtendField_1;
    }

    public String getPay_profit_loss_extend_field_2() {
        return pay_profit_loss_extend_field_2;
    }

    public void setPay_profit_loss_extend_field_2(String payProfitLossExtendField_2) {
        pay_profit_loss_extend_field_2 = payProfitLossExtendField_2;
    }

    public String getPay_profit_loss_extend_field_3() {
        return pay_profit_loss_extend_field_3;
    }

    public void setPay_profit_loss_extend_field_3(String payProfitLossExtendField_3) {
        pay_profit_loss_extend_field_3 = payProfitLossExtendField_3;
    }

    public String getPay_profit_loss_attr_1() {
        return pay_profit_loss_attr_1;
    }

    public void setPay_profit_loss_attr_1(String payProfitLossAttr_1) {
        pay_profit_loss_attr_1 = payProfitLossAttr_1;
    }

    public String getPay_profit_loss_attr_2() {
        return pay_profit_loss_attr_2;
    }

    public void setPay_profit_loss_attr_2(String payProfitLossAttr_2) {
        pay_profit_loss_attr_2 = payProfitLossAttr_2;
    }

    public String getPay_profit_loss_attr_3() {
        return pay_profit_loss_attr_3;
    }

    public void setPay_profit_loss_attr_3(String payProfitLossAttr_3) {
        pay_profit_loss_attr_3 = payProfitLossAttr_3;
    }

    public String getPay_profit_loss_attr_4() {
        return pay_profit_loss_attr_4;
    }

    public void setPay_profit_loss_attr_4(String payProfitLossAttr_4) {
        pay_profit_loss_attr_4 = payProfitLossAttr_4;
    }

    public String getPay_profit_loss_attr_5() {
        return pay_profit_loss_attr_5;
    }

    public void setPay_profit_loss_attr_5(String payProfitLossAttr_5) {
        pay_profit_loss_attr_5 = payProfitLossAttr_5;
    }

    public String getPay_profit_loss_attr_6() {
        return pay_profit_loss_attr_6;
    }

    public void setPay_profit_loss_attr_6(String payProfitLossAttr_6) {
        pay_profit_loss_attr_6 = payProfitLossAttr_6;
    }

    public String getPay_profit_loss_attr_7() {
        return pay_profit_loss_attr_7;
    }

    public void setPay_profit_loss_attr_7(String payProfitLossAttr_7) {
        pay_profit_loss_attr_7 = payProfitLossAttr_7;
    }

    public String getPay_profit_loss_attr_8() {
        return pay_profit_loss_attr_8;
    }

    public void setPay_profit_loss_attr_8(String payProfitLossAttr_8) {
        pay_profit_loss_attr_8 = payProfitLossAttr_8;
    }

    public String getPay_profit_loss_attr_9() {
        return pay_profit_loss_attr_9;
    }

    public void setPay_profit_loss_attr_9(String payProfitLossAttr_9) {
        pay_profit_loss_attr_9 = payProfitLossAttr_9;
    }

    public String getPay_profit_loss_attr_10() {
        return pay_profit_loss_attr_10;
    }

    public void setPay_profit_loss_attr_10(String payProfitLossAttr_10) {
        pay_profit_loss_attr_10 = payProfitLossAttr_10;
    }

    public String getPay_profit_loss_income_decr() {
        return pay_profit_loss_income_decr;
    }

    public void setPay_profit_loss_income_decr(String payProfitLossIncomeDecr) {
        pay_profit_loss_income_decr = payProfitLossIncomeDecr;
    }

    public String getPay_profit_loss_cost_incr() {
        return pay_profit_loss_cost_incr;
    }

    public void setPay_profit_loss_cost_incr(String payProfitLossCostIncr) {
        pay_profit_loss_cost_incr = payProfitLossCostIncr;
    }

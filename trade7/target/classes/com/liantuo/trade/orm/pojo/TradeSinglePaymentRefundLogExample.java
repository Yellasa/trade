...
public class TradeSinglePaymentRefundLogExample {
    ...
    public TradeSinglePaymentRefundLogExample() {
     ...
     * This class corresponds to the database table trade_single_payment_refund_log
     *

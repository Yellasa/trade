...
public class TradeValidationUtil {
     ...
     * @return 验证错误信息
     */
    public static String validateRequestWeak(TradeNotifyRequestBody tradeRquest) {
        String headValidRetMsg = ValidationUtil.validateRequiredWeaks(tradeRquest.getNotifyRequestHead());
        /*String bodyValidRetMsg = ValidationUtil.validateRequiredWeaks(tradeRquest.getBody());
        if (!StringUtils.isEmpty(headValidRetMsg) || !StringUtils.isEmpty(bodyValidRetMsg)) {
            String validateErrorMsg = !StringUtils.isEmpty(headValidRetMsg) ? headValidRetMsg : bodyValidRetMsg;
            return validateErrorMsg;
        } else {
        ...
        if (!StringUtils.isEmpty(headValidRetMsg) ) {
            return headValidRetMsg;
        } else {
            return null;
        }

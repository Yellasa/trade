...
public class WithdrawPayResultQueryTest extends AbstractTransactionalJUnit4SpringContextTests {

    @Resource
    private TradeBusController tradeBusController;
    
    TradePacketReqSingleWithdrawPayResultQuery req = null;
    
    @Before
    public void before(){
        req = new TradePacketReqSingleWithdrawPayResultQuery();
        
        TradePacketHead head = new TradePacketHead();
        head.setPartner_id("10000002048131212");
        head.setRequest_code("0002_001_004");

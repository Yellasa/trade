 ...
 * v1.1
 */
@JobFlow(value = "0002_001_998", version = "1.1", template = ATradePageQueryNoPaymentTemp.class)
public class QueryByPageSingleWithdrawOuterProcess implements TradePageQueryInterface<TradePacketReqBodySingleWithdrawPageDetails> {

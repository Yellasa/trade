...
public interface CreditAccountService {
    ...
    * @date 2016-4-27 下午2:02:05
    ...
    int countAdvanceAccountInnerByQueryVO(CreditAccountQueryInnerVo creditAccountQueryVo);
    
    int countAdvanceAccountByQueryVO(CreditAccountQueryVo creditAccountQueryVo);

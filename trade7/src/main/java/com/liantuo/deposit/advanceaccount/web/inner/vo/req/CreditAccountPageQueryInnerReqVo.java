 ...
 * -----------------------------------------------------------------------------------<br>
 */
public class CreditAccountPageQueryInnerReqVo{
	/**
	...
	* @字段名 accountNo : 账户编号
	*/
	@CannotEmptyString(message = "accountNo format error", regexp = RegexConstants.ACCOUNTNO_REGEX)
	private String accountNo;
	
	/**
	* @字段名 merchantNo : 商户编号
	*/
	@Length(min=2,max=32,message="merchantNo format error")
	private String merchantNo;
	/**
	* @字段名 accountName : 账户名称
	*/
	@Length(min=1,max=45,message="accountName format error")
	private String accountName;
	/**
	* @字段名 accountType : 账户类型
	* 账户类型：1-企业; 2-个人; 3-内部账户
	*/
	@Pattern(message = "accountType format error", regexp = "[1|2|3]")
	private String accountType;
	/**
	* @字段名 status : 账户状态
	* 账户状态：0-不可用；1-正常；2-冻结状态；3-待确认
	*/
	...
	*/
	@CannotEmptyString(message="createTimeStart format error", regexp = TradeConstants.TRADE_REGEX_FORMAT_PAY_DATE)
	private String createTimeStart;
	
	/**
	* @字段名 createTimeEnd : 结束时间
	*/
	@CannotEmptyString(message="createTimeEnd format error", regexp = TradeConstants.TRADE_REGEX_FORMAT_PAY_DATE)

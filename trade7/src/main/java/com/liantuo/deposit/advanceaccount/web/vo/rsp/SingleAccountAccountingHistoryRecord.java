...
public class SingleAccountAccountingHistoryRecord {
	...
	private String rmk;
	private String avlBalIncrAmt;
	private String avlBalDecrAmt;
	private String frozenBalIncrAmt ;
	private String frozenBalDecrAmt;
	private String availibleBalance ;
	...
	public void setDepositRecordNo(String depositRecordNo) {
		this.depositRecordNo = depositRecordNo;
	}
	...
	public String getAvlBalIncrAmt() {
		return avlBalIncrAmt;
	}
	public void setAvlBalIncrAmt(String avlBalIncrAmt) {
		this.avlBalIncrAmt = avlBalIncrAmt;
	}
	public String getAvlBalDecrAmt() {
		return avlBalDecrAmt;
	}
	public void setAvlBalDecrAmt(String avlBalDecrAmt) {
		this.avlBalDecrAmt = avlBalDecrAmt;
	}
	public String getFrozenBalIncrAmt() {
		return frozenBalIncrAmt;
	}
	public void setFrozenBalIncrAmt(String frozenBalIncrAmt) {
		this.frozenBalIncrAmt = frozenBalIncrAmt;
	}
	public String getFrozenBalDecrAmt() {
		return frozenBalDecrAmt;
	}
	public void setFrozenBalDecrAmt(String frozenBalDecrAmt) {
		this.frozenBalDecrAmt = frozenBalDecrAmt;
	}
	public String getAvailibleBalance() {
		return availibleBalance;
	}
	public void setAvailibleBalance(String availibleBalance) {
